    ...
    <div className="h-16 bg-white/60 backdrop-blur-sm dark:bg-[#040617]/60 border-b dark:border-b-gray-800 border-b-gray-200 fixed top-0 left-0 right-0 duration-300 z-10">
      ...
      <div className="max-w-7xl mx-auto hidden md:flex justify-between items-center gap-10 h-full px-4">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <Link to="/">
              <h1 className="hidden md:block font-extrabold text-2xl gradient-text">E-Learning</h1>
            </Link>
          </div>
        ...
        <div className="flex items-center gap-6">
          {user ? (
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" onClick={() => navigate("/login")} className="px-4 py-2">Login</Button>
              <Button onClick={() => navigate("/login")} className="px-4 py-2">Signup</Button>
            </div>
          )}
          <DarkMode />
        </div>
      ...
      <div className="flex md:hidden items-center justify-between px-4 h-full">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-extrabold text-lg text-gray-900 dark:text-white">E-learning</h1>
        </div>
